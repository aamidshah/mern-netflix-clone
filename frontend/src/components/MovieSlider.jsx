...
// here we remove all the underscores from the category text and covert their first letter to upper case 
        ...
        {content.map((item)=>(
          <Link to={`/watch/${item.id}`} className="min-w-[250px] relative group " key={item.id} >
            ...
            <div className='rounded-lg overflow-hidden '>
              ...
              <img src={SMALL_IMG_BASE_URL + item.backdrop_path} alt="movie img" 
